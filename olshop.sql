...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Okt 2024 pada 04.05
...
--
ALTER TABLE `pesanan`
  ADD CONSTRAINT `pesanan_ibfk_1` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
